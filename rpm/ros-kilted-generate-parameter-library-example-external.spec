...
Name:           ros-kilted-generate-parameter-library-example-external
Version:        0.5.0
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS generate_parameter_library_example_external package

License:        BSD-3-Clause
Source0:        %{name}-%{version}.tar.gz

Requires:       ros-kilted-ament-cmake-core
Requires:       ros-kilted-generate-parameter-library-example
...
BuildRequires:  ros-kilted-generate-parameter-library-example
