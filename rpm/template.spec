...
Name:           ros-kilted-generate-parameter-library
Version:        0.7.6
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS generate_parameter_library package

License:        BSD-3-Clause
URL:            https://index.ros.org/p/generate_parameter_library/#kilted
Source0:        %{name}-%{version}.tar.gz

Requires:       expected-devel
Requires:       fmt-devel
Requires:       ros-kilted-generate-parameter-library-py
...
* Thu Jun 12 2025 Paul Gesel <paul.gesel@picknik.ai> - 0.5.0-1
- Autogenerated by Bloom

* Tue Apr 22 2025 Paul Gesel <paul.gesel@picknik.ai> - 0.4.0-2
- Autogenerated by Bloom
